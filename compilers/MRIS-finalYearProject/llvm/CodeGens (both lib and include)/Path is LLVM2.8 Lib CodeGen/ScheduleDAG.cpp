                      ...
                      MachineBasicBlock::iterator insertPos)
{
  ...
  static int bbCount = 0;
  MachineBasicBlock::iterator i, e;

  // for (i = bb->begin(), e = bb->end(), bbCount = 1; i == e; i++) {
  //   assert ("Block");
  //   std::cout << "Block number: " << bbCount++ << "insertPos: " << insertPos << std::endl;
  //   errs() << *i << "\n";
  // }
  // mycode ends here
  ...
  // std::cout << "Entry and exit SU:\n";
  // EntrySU.getInstr()->dump();
  // dumpNode (EntrySU);
  // dumpNode (ExitSU);
